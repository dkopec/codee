...
class TumblrRestClient(object):
    ...
    def queue_post(self, blogname, post_id, type):
        ...
        :param blogname: a string, the name of the blog you want to use
        ...
        :returns: None
        """
        self.edit_post(blogname, id=post_id, type=type, state='queue')

    @validate_blogname
    def draft_post(self, blogname, post_id, type):
        """
        Transfers post from a given blogs drafts to its queue.
    ...
    def all_queued(self, blogname, offset=0):
        ...
        while True:
            ...
            request = self.queue(blogname, offset=offset)
            offset += 20
            request_counter += 1
    ...
    @validate_blogname
    def all_drafts(self, blogname, before_id=0):
        """
        Transfers posts from a given blogs drafts to its queue until the queue
        is full or drafts are empty.
        ...
        while True:
            ...
            request = self.drafts(blogname, before_id=before_id)
            request_counter += 1
            print("Request #", request_counter)
            ...
            data["_links"] = request["_links"]

            before_id = data["_links"]["next"]["query_params"]["before_id"]
        ...
        while queued_posts < 300 and drafts["posts"]:
            ...
            for index, post in enumerate(drafts["posts"]):
                ...
                if organic and index > 0:
                    ...
                    previous_author = previous_author.replace(" ", "-")
